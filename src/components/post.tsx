...
export default function Post({ slug }: Props) {
  ...
  return (
    <div>
      ...
      <h1 className="text-5xl font-firaCode text-cyan-900 text-center leading-relaxed font-bold mt-5">
        {data?.title}
      </h1>
      ...
      <div
        className="blog-content font-firaCode text-xl leading-loose flex flex-col gap-5 mt-5"
